...
for i, experiments in enumerate(experiments):
    
    print(f'Training NNs with width={experiments["width"]}\n\n')
    plt.title(f'NN with width={experiments["width"]}')
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
